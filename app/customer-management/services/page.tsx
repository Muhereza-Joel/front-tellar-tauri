            ...
            <div className="p-4 border-b border-zinc-100 dark:border-zinc-800 flex justify-between items-center flex-wrap gap-2">
              <div className="relative flex-1 min-w-[200px]">
                ...
                <input
                  ...
                  className="w-full bg-zinc-50 dark:bg-zinc-900/50 border-none pl-10 pr-4 py-2 text-sm outline-none text-zinc-900 dark:text-zinc-100"
                  value={searchTerm}
              ...
              <button
                ...
                className="flex items-center gap-1 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold px-3 py-1.5"
              >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-col gap-1">
                            <span className="font-bold text-zinc-800 dark:text-zinc-200 flex items-center gap-2">
                              {s.name}
                              {!s.is_active && (
                                <span className="text-[9px] bg-red-100 text-red-600 dark:bg-red-900/30 px-1.5 py-0.5">
                                  INACTIVE
                                </span>
                              )}
                            </span>
                            <div className="flex gap-2 flex-wrap">
                              <span className="flex items-center gap-1 text-[9px] text-zinc-400 uppercase bg-zinc-100 dark:bg-zinc-800 px-1">
                                <Layers size={10} />{" "}
                                {categoriesList.find(
                              ...
                              {s.is_rental && (
                                <span className="flex items-center gap-1 text-[9px] text-purple-600 uppercase bg-purple-100 dark:bg-purple-900/30 px-1 ">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-col">
                            <span className="font-bold text-zinc-800 dark:text-zinc-100">
                              Ugx {s.base_price.toLocaleString()}
                              {s.is_rental && (
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-col gap-1.5">
                            ...
                            {s.requires_appointment && (
                              <span className="text-[9px] bg-blue-100 text-blue-600 dark:bg-blue-900/30 px-1.5 inline-flex items-center gap-1 w-fit">
                                <Calendar size={10} /> Appointment
                              </span>
                            )}
                            {s.max_bookings_per_slot > 1 && (
                              <span className="text-[9px] bg-orange-100 text-orange-600 dark:bg-orange-900/30 px-1.5 w-fit">
                ...
                <form onSubmit={handleSave} className="space-y-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          ...
                          className=" border-zinc-300 dark:border-zinc-700 text-blue-600 bg-transparent"
                        />
                  ...
                  {activeTab === "rental" && (
                    <div className="space-y-4">
                      ...
                      {formData.is_rental && (
                        <div className="space-y-4 p-4 bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30">
                          <div className="grid grid-cols-2 gap-3">
                            <div>
                              <label className={labelClass}>
                                Deposit Required
                  ...
                  {activeTab === "availability" && (
                    <div className="space-y-4">
                      ...
                      {availabilityList.length === 0 && (
                        <div className="text-center py-6 border border-dashed text-zinc-400 text-xs">
                      ...
                      {availabilityList.map((daySchedule, dayIdx) => (
                        <div
                          key={dayIdx}
                          className="border border-zinc-200 dark:border-zinc-800  p-3 space-y-3"
                        >
                          <div className="flex justify-between items-center">
                            <select
                              ...
                              className="text-xs font-bold bg-transparent border border-zinc-300 dark:border-zinc-700  px-2 py-1"
                            >
                              {daysOfWeek.map((d) => (
                            ...
                            {daySchedule.slots.map((slot, slotIdx) => (
                              ...
                              >
                                <input
                                  ...
                                  className="w-24 px-2 py-1 text-xs border bg-white dark:bg-black"
                                />
                      ...
                      {metadataList.map((entry, idx) => (
                        <div key={idx} className="flex items-center gap-2">
                          <input
                            ...
                            className="flex-1 px-2 py-1 text-xs border bg-white dark:bg-black"
                          />
                          <input
                            type="text"
                            placeholder="Value"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
                  >
