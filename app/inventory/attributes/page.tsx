            ...
            <div className="bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
              ...
              <form onSubmit={handleSave} className="space-y-4">
                ...
                {formData.fieldType === "select" && (
                  <div className="space-y-2 p-3 bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-100 dark:border-zinc-800">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        type="button"
                        onClick={addOption}
                        className="bg-blue-600 text-white px-3 hover:bg-blue-700 transition-colors"
                      >
                        <Plus size={16} />
                      </button>
                    </div>
                    <div className="flex flex-wrap gap-1 mt-2">
                      {formData.options.map((opt, i) => (
                        <span
                          key={i}
                          className="bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 text-[10px] px-2 py-1 flex items-center gap-1 text-zinc-700 dark:text-zinc-300"
                        >
                          {opt}{" "}
                          <X
                            size={10}
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    type="submit"
                    className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 flex items-center justify-center gap-2 transition-all active:scale-[0.99] shadow-sm"
                  >
              ...
              <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
                {attributesList.map((attr) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2 text-xs text-zinc-500 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-900 px-2 py-1 w-fit uppercase font-medium">
